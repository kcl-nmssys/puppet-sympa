class sympa (
  ...
  String $config_file = '/etc/sympa/sympa/sympa.conf',
  ...
  String $db_env = undef,
  String $db_additional_subscriber_fields = undef,
  String $db_additional_user_fields = undef,
  String $syslog = 'mail',
  ...
  String $wwsympa_url = "https://${facts['fqdn']}/sympa",
  Optional[String] $http_host = undef,
  String $static_content_url = '/static-sympa',
  String $static_content_path = "${var_dir}/static_content",
